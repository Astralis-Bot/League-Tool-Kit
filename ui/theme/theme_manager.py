# ui/theme/theme_manager.py - Gerenciador de temas
import json
import os
...
class ThemeManager:
    """Gerenciador de temas para o aplicativo"""
    ...
    def validate_theme(self, theme_data: Dict) -> bool:
        """Valida se um tema possui todos os campos obrigatórios"""
    ...
    def generate_theme_id(self, theme_name: str) -> str:
        """Gera um ID único baseado no nome do tema"""
    ...
    def load_theme(self) -> str:
        """Carrega o tema salvo ou retorna padrão"""
