# ui/components.py - Componentes reutilizáveis da UI - CORRIGIDO
import customtkinter as ctk
from ui.ui_config import THEME, SIDEBAR_ITEMS


class Sidebar(ctk.CTkFrame):
    """Sidebar lateral com navegação - Com suporte a temas dinâmicos"""
...
class FeatureCard(ctk.CTkFrame):
    """Card para ativar/desativar features - COM SUPORTE A show_icon"""
